...
const NUMBERS = [
  { label: "+254 798 118515", href: "https://wa.me/254798118515" },
  { label: "+254 708 769459", href: "https://wa.me/254708769459" },
];
  ...
  return (
    <div className="fixed bottom-6 left-4 sm:bottom-8 sm:left-6 z-50 flex flex-col items-start gap-3">
      ...
      <button
        ...
        aria-expanded={open}
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-emerald-600/30 transition-transform hover:scale-110"
      >
