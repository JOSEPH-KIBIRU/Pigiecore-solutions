    ...
    <main id="top" className="site-root redesign-root">
      ...
      <section id="solutions" className="section-shell section-block">
        ...
        <div className="solution-grid">
          {solutionCards.map(({ tag, title, copy, metric, metricLabel, className, icon: Icon }, index) => (
            <article key={title} className={`solution-card ${className}`}>
              ...
              <div className="solution-body">
                <h3>{title}</h3>
                <p>{copy}</p>
                <div className="solution-metric"><strong>{metric}</strong><span>{metricLabel}</span></div>
              </div>
      ...
      <footer className="footer section-shell">
        <div className="footer-top"><a className="brand" href="#top"><span className="brand-mark">P</span><span>Pigiecore</span></a><span>Custom software · SaaS · automation · integrations</span></div>
        <div className="footer-bottom"><span>© {new Date().getFullYear()} Pigiecore Solutions</span><span>Nairobi, Kenya</span><a href="mailto:support@pigiecore.co.ke">support@pigiecore.co.ke</a></div>
      </footer>
    </main>
  );
}
