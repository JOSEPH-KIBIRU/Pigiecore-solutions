...
export const metadata: Metadata = {
  ...
  description:
    "Pigiecore Solutions is a software development company in Kenya building custom software, web applications, and business automation for real estate, logistics, salons, schools, and hospitals.",
